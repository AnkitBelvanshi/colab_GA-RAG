...
# --- FIX STARTS HERE ---
    if len(data) > 0:
        ...
        print("Warning: The evaluation dataset is empty. Cannot calculate results.")
        # You can decide what `result` should be here.
        # Maybe an empty list or a list of zeros.
        result = [0] * len(result)
# --- FIX ENDS HERE ---
    ...
    # If the dataset is empty, the results should be zero
        e2e = [0] * len(e2e)
