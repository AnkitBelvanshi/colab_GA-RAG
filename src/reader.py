...
cls_mapping = {
    # This is the new, corrected line for local loading
    "Mistral-7b": (MistralForCausalLM, AutoTokenizer, True, "Mistral-7B-Instruct-v0.2"),
    "OpenLlama-3b": (LlamaForCausalLM, LlamaTokenizer, True, "open_llama_3b_v2"),
    "Llama-3.2-1B": (AutoModelForCausalLM, AutoTokenizer, True, "Meta-Llama-3.2-1B-Instruct"), 
    "TinyLlama": (AutoModelForCausalLM, AutoTokenizer, True, "TinyLlama-1.1B-Chat-v1.0"),
...
class Reader(torch.nn.Module):
    def __init__(self, opt):
        ...
        self.model = model_cls.from_pretrained(
            os.path.join(opt.model_dir, hf_name),
